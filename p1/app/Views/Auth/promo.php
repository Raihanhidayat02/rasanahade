...
<section id="promo" class="container mx-auto py-12">
    <h2 class="text-3xl font-bold text-center mb-8 text-red-theme">Promo Spesial</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Promo 1: Tahun Baru -->
        <div class="bg-white p-6 rounded-lg shadow-lg promo-card">
            <div class="text-center">
                <h3 class="text-2xl font-bold text-red-theme mb-4">Tahun Baru, Diskon Besar!</h3>
                <p class="text-gray-600 mb-4">Rayakan tahun baru dengan diskon hingga 30% untuk semua menu.</p>
                <button class="bg-red-theme text-white px-6 py-2 rounded-lg btn-hover">Lihat Detail</button>
            </div>
        </div>

        <!-- Promo 2: Paket Keluarga -->
        <div class="bg-white p-6 rounded-lg shadow-lg promo-card">
            <div class="text-center">
                <h3 class="text-2xl font-bold text-red-theme mb-4">Paket Keluarga Hemat</h3>
                <p class="text-gray-600 mb-4">Nikmati paket keluarga dengan harga spesial, cocok untuk acara kumpul-kumpul.</p>
                <button class="bg-red-theme text-white px-6 py-2 rounded-lg btn-hover">Lihat Detail</button>
            </div>
        </div>

        <!-- Promo 3: Cashback Mingguan -->
        <div class="bg-white p-6 rounded-lg shadow-lg promo-card">
            <div class="text-center">
                <h3 class="text-2xl font-bold text-red-theme mb-4">Cashback Mingguan</h3>
                <p class="text-gray-600 mb-4">Dapatkan cashback hingga 20% setiap minggu untuk</p>
            </div>
        </div>
    </div>
</section>
